...
chlo_area <- chlo_area_raw %>% 
  rename(twohr_area = twohr_area_meters_sq,
         twohr_length = twohr_length_meters,
         feeding_area = feeding_area_meters_sq,
         feeding_length = feeding_length_meters)

fish_meta <- fish_meta_raw %>% 
  rename(total_length = total_length_cm)
